...
echo "deb [signed-by=/usr/share/keyrings/nginx-archive-keyring.gpg] https://plus-pkgs.nginx.com/debian ${version_codename} nginx-plus" >> /etc/apt/sources.list.d/nginx-plus.list
